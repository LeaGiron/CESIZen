...
const MobilePageAccueil = require('@/app/index').default;

describe('index - tests de non-régression', () => {
  it('affiche les actions principales de la page d’accueil', () => {
    // Ce test vérifie que l’écran d’accueil reste utilisable :
    // description + boutons principaux.
    const { getByText } = render(React.createElement(MobilePageAccueil));
