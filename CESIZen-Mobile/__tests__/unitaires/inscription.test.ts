...
const Inscription = require('@/app/inscription').default;
...
describe('inscription - tests unitaires', () => {
  ...
  it('affiche les champs du formulaire d’inscription', () => {
    // On vérifie que l’écran contient les champs principaux.
  ...
  it('appelle la fonction d’inscription au clic', () => {
    const { getByText } = render(React.createElement(Inscription));
